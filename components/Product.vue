...
<template>
    <div class="tw-flex tw-justify-between">
        <div class=" tw-relative tw-rounded-[19px] tw-overflow-hidden tw-w-[25%] tw-h-fit">
        ...
        <div class="tw-flex tw-justify-between  tw-w-[68%]">
            ...
            <IconsHeart :active="active" @click="active = !active" />
        </div>
    </div>
</template>