...
<template>
    <svg width="20" height="20" viewBox="0 0 24 24" :fill="active ? '#D20653' : 'white'"
        ...
        <path
            ...
            :stroke="active ? '#D20653' : 'black'" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
</template>