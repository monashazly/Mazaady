<template>
    <div class=" tw-flex tw-justify-between tw-position-fixed tw-top-0 tw-bg-white tw-py-4 tw-px-16 tw-items-center ">
        <div class=" tw-flex tw-justify-start tw-gap-6 tw-text-stone-500 ">
            <NuxtLink to="/">
                <NuxtImg src="/logo.png" width="70" />
            </NuxtLink>
            <NuxtLink to="/" exact-active-class="active-link">
                Home
            </NuxtLink>
            <NuxtLink to="/blogs" exact-active-class="active-link">
                Blog
            </NuxtLink>
            <NuxtLink exact-active-class="active-link">
                Gifts
            </NuxtLink>
        </div>
        <div class=" tw-items-center tw-flex tw-justify-start tw-gap-6">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7.99998 3H8.99998C7.04998 8.84 7.04998 15.16 8.99998 21H7.99998" stroke="#333333"
                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M15 3C16.95 8.84 16.95 15.16 15 21" stroke="#333333" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M3 16V15C8.84 16.95 15.16 16.95 21 15V16" stroke="#333333" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                <path d="M3 9.00001C8.84 7.05001 15.16 7.05001 21 9.00001" stroke="#333333" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            EN
        </div>
